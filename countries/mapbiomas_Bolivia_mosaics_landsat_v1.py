...
# ee.Initialize(project='ee-rcamargo')

sys.dont_write_bytecode = True
#sys.path.append(os.path.abspath('../'))

sys.path.append(os.path.abspath('E:/F_RAISG_2024/Script_mosaicos/mapbiomas-mosaics-mb-amazonia-1/'))
...
csvFile = './mapbiomas/data/Parametrización_de_mosaicos_Bolivia_C3_vfinal_2025.csv'
...
outputCollections = {
    'l4': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2',
    'l5': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2',
    'l7': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2',
    'l8': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2',
    'l9': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2',
    'lx': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2',
    'ly': 'projects/mapbiomas-bolivia/assets/MOSAICS/mosaics-2'
}
...
def getExcludedImages(country, year):
    ...
    assetId = 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2'
